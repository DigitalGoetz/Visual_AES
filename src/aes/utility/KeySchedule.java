...
public class KeySchedule {
    ...
    private void printKeyList(){
        System.out.println();
        System.out.println("KEYS FOR KEYSIZE=" + this.keySize +" Bytes in length");
        for(int i = 0; i < keyList.size(); i++){
            if(i < 10){
                System.out.println("0" + i + ": " +keyList.get(i).toString());
            }else{
                System.out.println(i + ": " +keyList.get(i).toString());
            }
